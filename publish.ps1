...
$ReleaseOnlyExclude = @(
    ...
    "tests",   # two of the test suites read src\exb-editor-shims.d.ts and type check the whole src folder, so they fail in a zip without the shims; run them from a repo clone
    "tools"
)
